...
const useStyles = makeStyles((theme) => ({
    ...
    selectedTicket: {
        backgroundColor: "#e3f2fd", // Pode manter um azul claro para seleção ou usar o do tema: theme.palette.primary.light
    },
    ticketQueueColor: {
        width: "6px",
        height: "100%",
    ...
    // ALTERAÇÃO 1: Ícone do WhatsApp para a cor primária do tema
    whatsappIcon: {
        fontSize: "16px",
        marginLeft: "4px",
    ...
    // ALTERAÇÃO 2: Notificações de mensagens não lidas para a cor primária do tema
    unreadBadge: {
        "& .MuiBadge-badge": {
    ...
    connectionCircle: {
        backgroundColor: blue[100], // Alterado para azul
        color: blue[600],
    },
    agentCircle: {
    ...
    // ALTERAÇÃO 3: Badge de conexão para azul
    connectionBadge: {
        backgroundColor: blue[100],
        color: blue[600],
    },
    ...
    // ALTERAÇÃO 4: Indicador de presença "Online" para azul
    presenceIndicator: {
        color: blue[500],
        fontWeight: "bold",
        fontSize: "0.8rem",
                ...
                return (
                    <>
                        <Tooltip title="Aceitar">
                            {/* PRESERVADO: Ícone de Aceitar continua verde */}
                            <CheckIcon
                        ...
                        <Tooltip title="Recusar">
                            {/* PRESERVADO: Ícone de Recusar continua vermelho */}
                            <CloseIcon
                                className={classes.actionIcon}
                                style={{ color: red[500] }}
